...
templates/       11 PRC-law Chinese markdown packages. Nine remain Prelegal
                 ...
                 texts). CSA, MNDA, professional-services-agreement,
                 data-processing-agreement, service-level-agreement,
                 software-license-agreement, and pilot-agreement have manifests
                 today; adding a doc to the full pipeline ≈ adding its manifest
                 here (+ flipping its catalog.json status to "available") plus
                 tests.
